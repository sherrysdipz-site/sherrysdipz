...
import { CheckCircle2, ChevronRight, Copy, Mail, Calendar, Clock } from 'lucide-react';
...
export function ThankYouPage() {
  ...
  const { confirmation, paymentMethod, customerName, pickupDate, pickupTime } = state;
  ...
  const formattedPickupDate = pickupDate
    ? new Date(pickupDate + 'T12:00:00').toLocaleDateString('en-CA', {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-card border rounded-2xl p-8 md:p-10 shadow-lg text-center animate-in zoom-in-95 duration-500">
        ...
        <div className="bg-accent rounded-xl p-6 mb-6 text-left border">
        ...
        {formattedPickupDate && pickupTime && (
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 mb-6 text-left">
            <div className="flex items-center gap-3 mb-3 text-primary">
              ...
              <h3 className="font-serif font-bold text-base">Your Pickup</h3>
            </div>
            <div className="flex items-center gap-2 text-foreground/80 text-sm mb-1">
        ...
        {isEtransfer && (
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 mb-6 text-left">
            <div className="flex items-center gap-3 mb-3 text-primary">
        ...
        {paymentMethod === 'cash' && (
          <div className="bg-muted rounded-xl p-6 mb-6 text-left text-sm text-muted-foreground">
